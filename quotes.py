quotes = {
    ...
    'c': 'Ever loved someone that much you would do anything for them? Let that someone be you and do whatever the hell you want',
    ...
    'Ahmed Nehyan': "I keep having vivid dreams of successthen it's time to go to sleep.",
    ...
    'Ali Yahya': 'New virus called "feelings". Don\'t catch that.',
    ...
    'Ammar Salman': 'Learn the  les like a pro, so that you can break them like an artist',
    ...
    'Awwab Aftab': 'No wonder life\'s lit "MNA ka BETA"',
    'Ayaan Faisal': 'No more homework, no more books! No more teacher’s dirty looks!',
    'Ayesha Brohi': 'Hey Google, turn off the school cameras.',
    'Aziz Ghaus': 'When’s this due?',
    'Bushra Noor': 'This place is gonna be really dark when I’m gone Bcs I’m taking my surname with me',
    ...
    'Fahad Farooq': "Life isn't about waiting for the storm to pass. Its about learning to dance in the rain.",
    'Faiz Faraz': 'Can I stay another year? - said nobody',
    ...
    'Haseeb Polani': '‘Attended less than half of the working days but still graduated’',
    ...
    'Innara Amir Ali': 'They asked me to write something so here it is:      Something ',
    ...
    'Laiba Abid': "Should've been Asad Farooqui.",
    ...
    'Rameez Hassan': 'It’s been a blur of fun. Came crying; left crying.',
    ...
    'Shahzar Abbas': 'Life is tough. But it’s tougher when you’re an idiot.',
    ...
    'Subika Haider': "I'm like y = eⁿ, I keep rising exponentially to infinity.",
    ...
    'Zainab Bandukwala': 'We graduated to go to school again.',
    ...
    'Nitesh Kumar':"Don't set limit, set an example.",
